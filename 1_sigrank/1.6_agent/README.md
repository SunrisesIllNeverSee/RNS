...
1. Where does the Python CLI live in this repo long-term? `1_sigrank/1.6_agent/` or its own subpackage?
...
The HTML prototypes in [../prototypes/](../prototypes/) provide visual reference. The components in [../../1_sigrank/1.5_components/sigrank/](../../1_sigrank/1.5_components/sigrank/) provide the UI building blocks.
