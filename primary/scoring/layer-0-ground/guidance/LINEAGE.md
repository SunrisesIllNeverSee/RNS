...
### Phase 2 · SigSystem
The word-level engine. Quantifies language by classifying words and tokens as signal or noise within their statement context. Lives in `primary/sig_army/` and `primary/word_vault/` — the 4,900-token classifier was built here.
