...
const TABS: Tab[] = [
  { id: 'message-volume', label: 'Message Volume' },
  { id: 'session-depth', label: 'Session Depth' },
  { id: 'compression-ratio', label: 'Compression Ratio' },
  { id: 'prompt-complexity', label: 'Prompt Complexity' },
  { id: 'x-referencing', label: 'X-Referencing' },
]
