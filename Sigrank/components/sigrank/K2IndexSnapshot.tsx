...
const SAMPLE_CLASSES: K2ClassEntry[] = [
  ...
  { signalClass: 'REFINER', trait: 'Repetition w Purpose', liveCount: 470, maxCount: 1645 },
...
const CLASS_DEFS: Partial<Record<SignalClass, string>> = {
  ...
  'ARCH+': 'You build structure from signal. Others follow your — Score 0.75–0.84',
  ARCH: 'You build structure from signal. Others follow your — Score 0.75–0.84',
...
const styles: Record<string, React.CSSProperties> = {
  ...
  header: {
    background: `linear-gradient(180deg, #0a1628 0%, ${colors.bg.surface} 100%)`,
